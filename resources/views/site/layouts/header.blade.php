            ...
            <div class="container">
                <div class="row"> <div class="col-md-6 col-sm-6 hidden-xs">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <!-- end social-media -->
                        <div class="language"> <span>Select Language</span>
                            <div class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle">
                                    English <img src="{{asset('assets/site/images/icon-flag-en.png')}}" alt="Image">
